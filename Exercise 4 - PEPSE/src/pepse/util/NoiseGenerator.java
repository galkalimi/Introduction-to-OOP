...
/**
 * NoiseGenerator class generates pseudo-random noise based on a seed for terrain generation.
 * The noise can be used to add variation to the terrain.
 */
public class NoiseGenerator {
     ...
     * The permutation array is used for generating pseudo-random noise.
     */
    private void init() {
    ...
    /**
     * Applies smoothing to the noise values.
    ...
    /**
     * Calculates the gradient value for the noise.
